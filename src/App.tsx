...
function App() {
  ...
  return (
    <div className="App">
      ...
      <p>
        <strong>USAGE</strong>: click to the edit button over each editable element
        to toggle the editable state. After modifying the field, click out of
        the component or press Escape to save.
      </p>
